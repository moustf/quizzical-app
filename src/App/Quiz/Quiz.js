...
export default function Quiz(props) {
  ...
  //       arr.push([...obj.incorrect_answers, obj.correct_answer])
  //     );
  //     return arr;
  //   });
  // }, []);
    ...
    <main className="quiz" style={props.style}>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[0].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[1].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[2].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[3].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[4].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[5].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[6].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[7].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[8].correct_answer}</p>
        </div>
      </section>
      <section className="que-component">
        ...
        <div className="answers">
          ...
          <p className="answer" onClick={isCorrect}>{data[9].correct_answer}</p>
        </div>
      </section>
